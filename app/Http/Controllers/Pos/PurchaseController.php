...
class PurchaseController extends Controller
{
    ...
    public function purchase_add()
    {
        ...
        return view('backend.purchase.purchase_add', compact('suppliers', 'categories', 'units', 'products'));
    ...
    public function purchase_delete($id)
    {
        ...
        $notification = array(
            'message' => 'Purchase Deleted Successfully', 'alert-type' => 'success',
        );
        return redirect()->back()->with($notification);
    } // end method
    ...
    public function purchase_approve($id)
    {
        ...
        $notification = array(
            'message' => 'Status Approved Successfully', 'alert-type' => 'success',
        );
        return redirect()->route('purchase.all')->with($notification);
    } // end method
