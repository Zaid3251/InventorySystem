                                    ...
                                    <div>
                                        ...
                                        <div class="">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <div class="md-3">
                                                        <label for="example-text-input" class="col-form-label">Date
                                                        </label>
                                                        <input class="form-control  example-date-input" name="date"
                                                            type="date" placeholder="YYYY-MM-DD" id="date">
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <div class="md-3" style="padding-top:35px;">
                                                        <button type="submit" class="btn btn-info">Invoice Update
                                                        </button>
                                                    </div>
                                                </div>
