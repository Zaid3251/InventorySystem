                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('purchase.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light"
                            style="float: right;"> <i class="fas fa-plus-circle"></i> add purchase</a><br><br>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($item->status =='0')
                                        <a href="{{ route('purchase.approve',$item->id) }}" class="btn btn-secondary sm"
                                            id="approveBtn" title="Approved">
